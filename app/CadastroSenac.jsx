...
// Removido: createClient / supabase instance
...
export default function About() {
  ...
  const handleRegister = async () => {
    ...
    if (!name || !normEmail || !password || !confirm) { setMsg("Preencha todos os campos."); return; }
    ...
    try {
      ...
      setTimeout(() => router.replace("/LoginSenac"), 1200);
    } catch (e) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.box}>
        {/* Removidos inputs duplicados e navegação incorreta */}
        <TextInput
